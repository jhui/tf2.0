...
def draw_bounding_box_on_image(image,
  ...
  # If the total height of the display strings
  # added to the top of the bounding
  # box exceeds the top of the image, stack the
  # strings below the bounding box
  # instead of above.
  display_str_heights = [font.getsize(ds)[1] for ds
                         in display_str_list]
...
def draw_boxes(image, boxes, class_names, scores,
  ...
  """Overlay labeled boxes on an image with formatted
  scores and label names."""
