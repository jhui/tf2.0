...
# This dataset contains translation pairs like
...
# <start> if you want to sound like a ... <end>
# <start> si quieres sonar como un hablante nativo ... <end>
...
# For demonstration, reduce/limit the dataset size
...
max_length_targ, max_length_inp = max_length(target_tensor), \
...
sample_output, sample_hidden = encoder(example_input_batch,
                                       sample_hidden)
# Encoder output shape: (batch size, sequence
# length, units) (64, 16, 1024)
# Encoder Hidden state shape: (batch size,
# units) (64, 1024)
